...
Route::prefix('v1')->group(function () {
    ...
    Route::middleware(['auth:api', 'admin'])->prefix('admin')->group(function () {
        ...
        Route::apiResource('produce', ProduceController::class);
        ...
        Route::get('farmers/{farmer}/listings', [AdminListingController::class, 'index']);
        Route::post('farmers/{farmer}/listings', [AdminListingController::class, 'store']);
        ...
        Route::post('disputes/{dispute}/messages', [AdminDisputeController::class, 'storeMessage']);
